...
export const MyBookDetails = observer(function MyBookDetails(props: MyBookDetailProps) {
  ...
  const [selectedSelling, setSelling] = React.useState(userBook ? userBook.selling : false);
  const [selectedLending, setLending] = React.useState(userBook ? userBook.lending : false);
  ...
  const [region, setRegion] = React.useState({
    latitude: userBook ? userBook.location[0] : 18.220833,
    longitude: userBook ? userBook.location[1] : -66.590149,
